...
interface FavouritesPageProps {
    ...
    onBrowseShowroom: () => void;
}

export function FavouritesPage({ favourites, onToggleFavourite, onCarClick, onBrowseShowroom }: FavouritesPageProps) {
