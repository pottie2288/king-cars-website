  ...
  return (
    <div className="w-full max-w-6xl mx-auto relative z-20">
      <div className="bg-white rounded-[1.5rem] md:rounded-full shadow-[0_8px_30px_rgb(0,0,0,0.12)] p-4 md:p-3 flex flex-col md:flex-row items-center justify-between gap-3 md:gap-0 transition-all duration-300">
        ...
        {/* Type / Category */}
        <div className="flex-1 w-full relative px-5 md:px-6 border border-gray-200 md:border-0 md:border-r md:border-gray-100 rounded-full md:rounded-none flex items-center h-[52px] md:h-14 bg-white md:bg-transparent">
          <select
            value={category}
        ...
        {/* Model */}
        <div className={`flex-1 w-full relative px-5 md:px-6 border border-gray-200 md:border-0 md:border-r md:border-gray-100 rounded-full md:rounded-none flex items-center h-[52px] md:h-14 ${!selectedMake ? 'bg-gray-50' : 'bg-white'} md:bg-transparent`}>
          <select
            value={selectedModel}
        ...
        {/* Variant */}
        <div className={`flex-1 w-full relative px-5 md:px-6 border border-gray-200 md:border-0 md:border-r md:border-gray-100 rounded-full md:rounded-none flex items-center h-[52px] md:h-14 ${!selectedModel ? 'bg-gray-50' : 'bg-white'} md:bg-transparent`}>
          <select
            value={variant}
        ...
        {/* Max Price */}
        <div className="flex-1 w-full relative px-5 md:px-6 border border-gray-200 md:border-0 rounded-full md:rounded-none flex items-center h-[52px] md:h-14 bg-white md:bg-transparent">
          <select
            value={maxPrice}
        ...
        {/* Search Button */}
        <div className="w-full md:w-auto px-0 md:px-2 pt-2 md:pt-0 pb-0 shrink-0">
          <button
            onClick={handleSearch}
            className="w-full md:w-[60px] h-[56px] md:h-[52px] bg-king-blue hover:bg-king-cyan text-white rounded-[1.25rem] md:rounded-[1rem] flex items-center justify-center gap-2 transition-all duration-300 shadow-md hover:shadow-lg"
          >
            <span className="md:hidden font-bold text-[18px]">Search</span>
