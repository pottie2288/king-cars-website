    ...
    return (
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
            ...
            <div className="space-y-3">
                <a
                    href={`https://wa.me/${car.location === 'Eastern Cape' ? '27680374018' : '27835008181'}?text=${encodeURIComponent(`Hi, I'm interested in the ${car.year} ${car.make} ${car.model} (${car.variant}) priced at R ${car.price.toLocaleString('en-ZA')}. Please can you assist?`)}`}
                    target="_blank"
